    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          <Text variant="bold" size="xl" style={styles.title}>Belajar Grammar Korea</Text>
          ...
          <View style={styles.infoBox}>
            ...
            <Text variant="regular" size="sm" style={styles.infoText}>
              Fitur pembelajaran grammar sedang dalam tahap pengembangan. Silakan kembali lagi nanti.
            </Text>
          </View>
        </View>
      </ScrollView>
